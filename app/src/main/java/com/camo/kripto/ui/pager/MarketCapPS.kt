...
import com.camo.kripto.data.api.CGService
import com.camo.kripto.data.model.CoinMarket

class MarketCapPS(private val backend: CGApiHelper, private val curr: String) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CoinMarket.CoinMarketItem> {
        try {
            ...
            val response = backend.getMarketCap(curr,nextPageNumber)
